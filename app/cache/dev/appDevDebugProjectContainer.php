...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'version1.0', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\GV\\ForumBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\GV\\UserBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\GV\\VilleBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'GV\\ForumBundle\\Entity');
        $c->addDriver($b, 'GV\\UserBundle\\Entity');
        $c->addDriver($b, 'GV\\VilleBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('GVForumBundle' => 'GV\\ForumBundle\\Entity', 'GVUserBundle' => 'GV\\UserBundle\\Entity', 'GVVilleBundle' => 'GV\\VilleBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9394fe19e4187d1296f30d0d38b9fb50601467e75000aa13a5334246fd2a6735');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('GV\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('swiftmailersymfony@gmail.com' => 'Msilini Fadoua'), 'resetting' => array('webmaster@example.com' => 'webmaster'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('GV\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('GV\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('GV\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'GV\\UserBundle\\Entity\\User');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \GV\UserBundle\Redirection\AfterDeniedRedirection A GV\UserBundle\Redirection\AfterDeniedRedirection instance.
     */
    protected function getRedirect_After_DeniedService()
    {
        return $this->services['redirect.after.denied'] = new \GV\UserBundle\Redirection\AfterDeniedRedirection($this->get('router'), $this->get('security.context'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \GV\UserBundle\Redirection\AfterLoginRedirection A GV\UserBundle\Redirection\AfterLoginRedirection instance.
     */
    protected function getRedirect_After_LoginService()
    {
        return $this->services['redirect.after.login'] = new \GV\UserBundle\Redirection\AfterLoginRedirection($this->get('router'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \GV\UserBundle\Redirection\AfterLogoutRedirection A GV\UserBundle\Redirection\AfterLogoutRedirection instance.
     */
    protected function getRedirect_After_LogoutService()
    {
        return $this->services['redirect.after.logout'] = new \GV\UserBundle\Redirection\AfterLogoutRedirection($this->get('router'), $this->get('security.context'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/Abonne');
        ...
        $l->add($k, array(0 => 'ROLE_Abonne'), NULL);
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\GV\\ForumBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\GV\\VilleBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\GV\\ForumBundle/Resources/views'), 'GVForum');
        $instance->addPath(($this->targetDirs[3].'\\src\\GV\\UserBundle/Resources/views'), 'GVUser');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\GV\\VilleBundle/Resources/views'), 'GVVille');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \GV\UserBundle\Form\RegistrationFormType A GV\UserBundle\Form\RegistrationFormType instance.
     */
    protected function getUser_Registration_FormService()
    {
        return $this->services['user.registration.form'] = new \GV\UserBundle\Form\RegistrationFormType('GV\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_Abonne' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GVForumBundle' => 'GV\\ForumBundle\\GVForumBundle',
                'GVUserBundle' => 'GV\\UserBundle\\GVUserBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'GVVilleBundle' => 'GV\\VilleBundle\\GVVilleBundle',
            ...
            'fos_user.model.user.class' => 'GV\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'swiftmailersymfony@gmail.com' => 'Msilini Fadoua',
            ),
